...
────────────────────────────────────────────────────────────────
  ...
  eta_m           = 0.98       (Issue #6 generic 기본값, 그대로)
...
출력:
  ../02_시뮬레이션_데이터/fuel_fault_data.csv            (fault: moderate/severe, 3,000샘플)
  ../02_시뮬레이션_데이터/combustor_real_normal_data.csv (정상: faultFactor_fuel=1.0, 3,000샘플)
...
def run_case(fault_factor, rng):
    ...
    T3, P3, far_demand, far_actual = combustor(T2, P2, comb_ref, fault_factor)
